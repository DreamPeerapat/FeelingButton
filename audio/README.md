...
`say` sentence record that whole sentence, not just the short label. All 37:
...
| catheterout | Requests & Help | I want the urinary catheter out. | อยากเอาสายสวนปัสสาวะออก ไม่สบายตัว |
